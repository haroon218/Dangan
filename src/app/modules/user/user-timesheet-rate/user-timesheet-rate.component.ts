...
@Component({
  selector: 'app-user-timesheet-rate',
  templateUrl: './user-timesheet-rate.component.html',
  styleUrls: ['./user-timesheet-rate.component.css']
})
export class UserTimesheetRateComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UserTimesheetRateComponent>,
