...
export class NavbarComponent implements OnInit {
    ...
    constructor(location: Location,private http: HttpClient ,  private element: ElementRef, private router: Router,public admindataservice: AdminDataServicesService) {
    ...
    async logout() {
        try {
          ...
          const imageUrl = 'https://dgr.sso.id/account/signout'; 
          const img = new Image();
          img.src = imageUrl;
